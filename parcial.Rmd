...
Aquí se presentan el codigo de JAGS para los modelos de regresión binomial con liga logística y complementaria log-log, así como el modelo de Poisson. Para encontrar el codigo completo, se recomienda visitar el repo del [Texto que quieres mostrar](https://www.ejemplo.com).
